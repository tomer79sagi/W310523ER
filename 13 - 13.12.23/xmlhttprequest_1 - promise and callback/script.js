...
const displayUsers = () => {
  // Option 1. A shorter way to extract the 'data' from resolve
  const result = getUsersFromServer();
  createTableFromUsers(result);


  // Option 2. 
  // const myPromise = getUsersFromServer();

  // myPromise
  //     // 2. Update UI
  //     .then(arrUsers => createTableFromUsers(arrUsers))
      
  //     // 3. Update UI with error
