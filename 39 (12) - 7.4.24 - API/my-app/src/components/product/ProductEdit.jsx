...
const ProductEdit = ( {selectedProduct, callbackSuccess} ) => {
    ...
    // 4. WITH SPECIFIC VARIABLE '[errors]' = Runs block ONLY if the 'errors' state object was changed
    useEffect(() => {
    ...
    // WITH SPECIFIC VARIABLE '[selectedProduct]' = Runs block ONLY if the 'selectedProduct' props object was changed
    useEffect(() => {
